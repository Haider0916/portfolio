...
export default function works() {
    ...
    return (
        <div className="py-16 px-16 lg:px-52 max-sm:pt-9 max-sm:px-9">
            <p className="flex font-bold text-3xl sm:justify-start mb-9">Works</p>
            {
                [1, 2, 3].map(_ => <>
                    <div className="bg-white py-5 sm:flex sm:items-center">
                        <div className="sm:w-2/5">
                            <ImageCarousel images={[Dashboard, Signup, Profile]} showArrows={true} />
                        </div>
                        <div className="bg-white sm:w-3/5 p-5 pt-0 max-sm:p-0">
                            ...
                            <p className="h-[240] sm:line-clamp-5 lg:line-clamp-3">{blogContent}</p>
                        </div>
                    </div>
                    <hr />
                </>
