...
export default function Home() {
  ...
  const intro = `Full stack developer with 3 years of experience specializing in JavaScript and its latest advancements. Proven track record in prominent product-base
                ...
                [1, 2, 3].map(_ => <>
                  <div className="bg-white py-3 md:p-0 sm:flex sm:items-center">
                    <div className="sm:1/4">
                      <ImageCarousel images={[Dashboard, Signup, Profile]} />
                    </div>
